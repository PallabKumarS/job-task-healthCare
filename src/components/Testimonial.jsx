...
import sarah from "../assets/image_user1.png";
import michael from "../assets/image_user3.png";
import david from "../assets/image_user3.png";
import jhon from "../assets/image_user2.png";
          ...
          <div className="bg-[#FFFFF5] rounded-2xl px-6 py-10">
            ...
            <div className="flex gap-6 mt-5">
              ...
              <div>
                <p className="text-[#4D4C7B] text-xs">
                  {" "}
                  <span className="font-semibold text-black">Jhon R,</span>{" "}
                  Business Executive
                </p>
                <div className="flex text-yellow-300">
                  <FaStar></FaStar> <FaStar></FaStar> <FaStar></FaStar>{" "}
